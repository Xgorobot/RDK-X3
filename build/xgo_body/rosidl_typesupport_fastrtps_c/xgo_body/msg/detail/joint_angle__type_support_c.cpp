...
#include "xgo_body/msg/detail/joint_angle__rosidl_typesupport_fastrtps_c.h"
...
using _JointAngle__ros_msg_type = xgo_body__msg__JointAngle;
...
size_t get_serialized_size_xgo_body__msg__JointAngle(
  const void * untyped_ros_message,
...
static uint32_t _JointAngle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xgo_body__msg__JointAngle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xgo_body
size_t max_serialized_size_xgo_body__msg__JointAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xgo_body__msg__JointAngle;
    is_plain =
      (
...
static size_t _JointAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xgo_body__msg__JointAngle(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xgo_body, msg, JointAngle)() {
