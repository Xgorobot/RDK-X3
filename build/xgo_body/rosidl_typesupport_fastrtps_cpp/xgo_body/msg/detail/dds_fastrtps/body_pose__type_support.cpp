...
#include "xgo_body/msg/detail/body_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xgo_body::msg::BodyPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xgo_body::msg::BodyPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xgo_body::msg::BodyPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BodyPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xgo_body::msg::BodyPose *>(
...
static size_t _BodyPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BodyPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BodyPose__callbacks = {
  "xgo_body::msg",
  "BodyPose",
...
static rosidl_message_type_support_t _BodyPose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BodyPose__callbacks,
...
{
  return &xgo_body::msg::typesupport_fastrtps_cpp::_BodyPose__handle;
}
