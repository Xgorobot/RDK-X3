...
static const _ArmPose_type_support_symbol_names_t _ArmPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xgo_body, msg, ArmPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xgo_body, msg, ArmPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xgo_body, msg, ArmPose)() {
  return &::xgo_body::msg::rosidl_typesupport_c::ArmPose_message_type_support_handle;
}
