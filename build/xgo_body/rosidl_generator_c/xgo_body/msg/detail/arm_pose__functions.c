...
xgo_body__msg__ArmPose__create()
{
  ...
  xgo_body__msg__ArmPose * msg = (xgo_body__msg__ArmPose *)allocator.allocate(sizeof(xgo_body__msg__ArmPose), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xgo_body__msg__ArmPose));
  bool success = xgo_body__msg__ArmPose__init(msg);
  if (!success) {
...
xgo_body__msg__ArmPose__destroy(xgo_body__msg__ArmPose * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    xgo_body__msg__ArmPose__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
xgo_body__msg__ArmPose__Sequence__init(xgo_body__msg__ArmPose__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xgo_body__msg__ArmPose * data = NULL;

  if (size) {
    data = (xgo_body__msg__ArmPose *)allocator.zero_allocate(size, sizeof(xgo_body__msg__ArmPose), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xgo_body__msg__ArmPose__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xgo_body__msg__ArmPose__fini(&data[i - 1]);
      }
...
xgo_body__msg__ArmPose__Sequence__fini(xgo_body__msg__ArmPose__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xgo_body__msg__ArmPose__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xgo_body__msg__ArmPose__Sequence * array = (xgo_body__msg__ArmPose__Sequence *)allocator.allocate(sizeof(xgo_body__msg__ArmPose__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xgo_body__msg__ArmPose__Sequence__init(array, size);
  if (!success) {
...
xgo_body__msg__ArmPose__Sequence__destroy(xgo_body__msg__ArmPose__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xgo_body__msg__ArmPose__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xgo_body__msg__ArmPose__Sequence__are_equal(const xgo_body__msg__ArmPose__Sequence * lhs, const xgo_body__msg__ArmPose__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xgo_body__msg__ArmPose__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xgo_body__msg__ArmPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xgo_body__msg__ArmPose);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xgo_body__msg__ArmPose * data =
      (xgo_body__msg__ArmPose *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xgo_body__msg__ArmPose__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xgo_body__msg__ArmPose__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xgo_body__msg__ArmPose__copy(
