...
: ${AMENT_CURRENT_PREFIX:="/home/sunrise/xgo_demo/src/install/xgo_face_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xgo_face_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/xgo_face_control/environment/path.sh"
