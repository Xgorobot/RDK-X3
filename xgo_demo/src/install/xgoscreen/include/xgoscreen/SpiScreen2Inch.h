#ifndef XGOSCREEN_SPISCREEN2INCH_H
#define XGOSCREEN_SPISCREEN2INCH_H
...
#include <xgoscreen/TGpioUtil.h>
#include <xgoscreen/TSpiUtil.h>

class SpiScreen2Inch : public QObject
{
  Q_OBJECT
public:
  SpiScreen2Inch(int controllerIndex, int deviceIndex, int spiFrequency, int gpioCS, int gpioRest, int gpioDC, bool fast_startup = false);
  ~SpiScreen2Inch();
  void showImg(QImage* img);

private:
  bool mFastStartup = false;
...
#endif // XGOSCREEN_SPISCREEN2INCH_H